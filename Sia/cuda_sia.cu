...
__global__ void cudaized_multi(struct hash_state *s, int32_t mixrounds, uint64_t *prebuf_le, uint8_t *input, uint32_t len, uint8_t *output, int64_t s_cost, uint32_t max_nonce, int thr_id, uint32_t *winning_nonce, uint32_t num_threads, uint32_t *device_target, uint32_t *is_winning, uint32_t num_blocks, uint8_t *sbufs);
...
uint32_t balloon_128_cuda(int thr_id, unsigned char *input, unsigned char *output, uint32_t *target, uint32_t max_nonce, uint32_t num_threads, uint32_t *is_winning, uint32_t num_blocks) {
	return cuda_balloon(thr_id, input, output, 80, 128, 4, target, max_nonce, num_threads, is_winning, num_blocks);
}
...
uint32_t cuda_balloon(int thr_id, unsigned char *input, unsigned char *output, int32_t len, int64_t s_cost, int32_t t_cost, uint32_t *target, uint32_t max_nonce, uint32_t num_threads, uint32_t *ret_is_winning, uint32_t num_blocks) {
#ifdef DEBUG
	...
	cudaized_multi << <num_blocks, num_threads >> > (device_s[thr_id], t_cost, device_prebuf_le[thr_id], device_input[thr_id], len, device_out[thr_id], s_cost, max_nonce, thr_id, device_winning_nonce[thr_id], num_threads, device_target[thr_id], device_is_winning[thr_id], num_blocks, device_sbufs[thr_id]);
...
//#define CUDA_OUTPUT
__global__ void cudaized_multi(struct hash_state *hs, int32_t mixrounds, uint64_t *prebuf_le, uint8_t *input, uint32_t len, uint8_t *output, int64_t s_cost, uint32_t max_nonce, int thr_id, uint32_t *winning_nonce, uint32_t num_threads, uint32_t *device_target, uint32_t *is_winning, uint32_t num_blocks, uint8_t *sbufs) {
#ifdef DEBUG_CUDA
